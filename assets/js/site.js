...
(() => {
  ...
  function buildDrawer(dict, lang){
    ...
    const items = [
      ...
      { key:"nav.works", page:"works.html", icon:"⌗" },
      { key:"nav.about", page:"about.html", icon:"∴" },
      { key:"nav.lookbook", page:"lookbook.html", icon:"⟡" },
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    // LOOKBOOK external link wiring
    const lb = document.querySelector("[data-lookbook-open]");
    if(lb){
